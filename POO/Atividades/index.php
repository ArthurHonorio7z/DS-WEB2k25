...
echo "Questão 1 <br>O total que o gerente " . $gerente->getNome() . " vai ganhar junto com o bonus " . $gerente->calBonus();
...
echo "Questão 3<br>Carro: " . $carro->modelo . " - " . $carro->marca . "\n";
echo "<br>";
echo "<br>";
...
echo "<br>Questão 4<br>Preço final do " . $eletronico->getNome() . ": R$" . $eletronico->calcularDesconto() . "\n";
echo "<br>";
...
if ($cpf->validar()) {
    echo "<br>Questão 5 <br>CPF válido";
} else {
    echo "<br>Questão 5 <br>CPF inválido";
}
?>